...
- Preview: https://main--adobe-storefront-demo--tszmyt-creatuity.hlx.page/
- Live: https://main--adobe-storefront-demo--tszmyt-creatuity.hlx.live/
...
1. Open the `adobe-storefront-demo` directory in your favorite IDE and start coding :)
